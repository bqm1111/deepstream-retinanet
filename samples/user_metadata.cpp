...
gint frame_number_user_metadata = 0;
gchar pgie_classes_str_user_meta_data[4][32] = { "Vehicle", "TwoWheeler", "Person",
  "Roadsign"
};
...
int user_metadata(int argc, char *argv[])
{
  ...
  g_object_set (G_OBJECT (pgie),
      "config-file-path", "../configs/user_metadata/dsmeta_pgie_config.txt", NULL);
