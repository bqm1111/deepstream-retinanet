...
#define INFER_PGIE_CONFIG_FILE "../configs/infer_meta/dstensor_pgie_config.txt"
#define INFER_SGIE1_CONFIG_FILE "../configs/infer_meta/dstensor_sgie1_config.txt"
#define INFER_SGIE2_CONFIG_FILE "../configs/infer_meta/dstensor_sgie2_config.txt"
#define INFER_SGIE3_CONFIG_FILE "../configs/infer_meta/dstensor_sgie3_config.txt"
#define INFERSERVER_PGIE_CONFIG_FILE "../configs/infer_meta/inferserver/dstensor_pgie_config.txt"
#define INFERSERVER_SGIE1_CONFIG_FILE "../configs/infer_meta/inferserver/dstensor_sgie1_config.txt"
#define INFERSERVER_SGIE2_CONFIG_FILE "../configs/infer_meta/inferserver/dstensor_sgie2_config.txt"
#define INFERSERVER_SGIE3_CONFIG_FILE "../configs/infer_meta/inferserver/dstensor_sgie3_config.txt"

#ifndef MAX_DISPLAY_LEN
#define MAX_DISPLAY_LEN 64
#endif
#ifndef PGIE_CLASS_ID_VEHICLE
#define PGIE_CLASS_ID_VEHICLE 0
#endif
#ifndef PGIE_CLASS_ID_PERSON
 ...
 * resolution. */
#ifndef MUXER_OUTPUT_WIDTH
#define MUXER_OUTPUT_WIDTH 1280
#endif
#ifndef MUXER_OUTPUT_HEIGHT
                          ...
                          gpointer u_data)
{
    ...
    g_print("Frame Number = %d Number of objects = %d "
            ...
            frame_number_infer, num_rects, vehicle_count, person_count);
    frame_number_infer++;
    return GST_PAD_PROBE_OK;
}

extern "C" bool NvDsInferParseCustomResnet(std::vector<NvDsInferLayerInfo> const &outputLayersInfo, NvDsInferNetworkInfo const &networkInfo,
         ...
         l_frame = l_frame->next)
    {
             ...
             l_user != NULL; l_user = l_user->next)
        {
            ...
            std::vector<std::vector<
                cv::Rect>>
                objectListClasses(PGIE_DETECTED_CLASS_NUM);
...
int infer_meta(int argc, char *argv[])
{
    ...
    GST_DEBUG_BIN_TO_DOT_FILE(GST_BIN(pipeline), GST_DEBUG_GRAPH_SHOW_ALL, "infer");
